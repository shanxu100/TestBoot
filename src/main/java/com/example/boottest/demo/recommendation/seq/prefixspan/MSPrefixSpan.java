...
public class MSPrefixSpan {
    ...
    private static Pattern p2 = Pattern.compile("\\d{1,}\\.\\d{1,}");
    private static Pattern p3 = Pattern.compile("MIS.*");
    private static Pattern p4 = Pattern.compile("SDC.*");

    private Map<Integer, Double> MIS = getItemsMIS();

    private ArrayList<Sequence> S = getSequences(MIS);
